...
public class BarLineChartViewBase: ChartViewBase, BarLineScatterCandleBubbleChartDataProvider, NSUIGestureRecognizerDelegate
{
    ...
    internal override func initialize()
    {
        ...
        _doubleTapGestureRecognizer = NSUITapGestureRecognizer(target: self, action: "doubleTapGestureRecognized:")
        _doubleTapGestureRecognizer.nsuiNumberOfTapsRequired = 2
        _panGestureRecognizer = NSUIPanGestureRecognizer(target: self, action: "panGestureRecognized:")
        ...
        #if !os(tvOS)
            _pinchGestureRecognizer = NSUIPinchGestureRecognizer(target: self, action: "pinchGestureRecognized:")
